...
Thank you for registering for ICCSTE 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@iccste.com. You can find the copyright form here: www.2019.iccste.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for ICCSTE'19";

$your_headers = "From: ICCSTE'19 <" . $my_email . ">";
...
<title>ICCSTE'19 - Registration Form Filled!</title>
  ...
  <div class="cbp-af-inner">
    <div class="unit unit-s-3-4 unit-m-1-3 unit-l-1-3">
      ...
      <div class="unit unit-s-1-3 unit-m-2-3 unit-m-2-3-1 unit-l-2-3">
        ...
        <div class="bg">
          <h1>2<sup>nd</sup> International Conference on Recent Trends in<br>Environmental Science and Engineering (ICCSTE'19)</h1>
          <p class="subhead">June 9 - 11, 2019 | Ottawa, Canada</p>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICCSTE'19!</p>
  </div>
</div>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICCSTE'19, please fill out the form below:</p>
